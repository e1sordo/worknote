<template>
    <div class="home">
      ...
      <h2>{{ $t("settings.predefinedWorknotes.title") }}</h2>
      <predefined-worklogs />
    </div> -->

        <!-- <hr /> -->
        <div class="m-4 text-start">
            <h2>{{ $t('settings.vacations.title') }}</h2>
            <vacations-table />
        </div>

        <!-- <hr /> -->
        <div class="m-4 text-start">
            <h2>{{ $t('settings.projects.title') }}</h2>
            <projects-table />
        </div>
            ...
            <form @submit.prevent="saveJiraSettings">
                <div class="row">
                    <div class="col-sm-6 mb-3">
                        <label for="proxyUrlInput" class="form-label">
                            {{ $t('settings.jira.form.proxyUrl.label') }}
                        </label>
                        <input type="text" id="proxyUrlInput" class="form-control" v-model="proxyUrl" />
                    </div>
                    <div class="col-sm-6 mb-3">
                        <label for="serverUrlInput" class="form-label">
                            {{ $t('settings.jira.form.serverUrl.label') }}
                        </label>
...
<script lang="ts">
    ...
    // import PredefinedWorklogs from "@/components/PredefinedWorklogs.vue";
    import VacationsTable from '@/components/settings/VacationsTable.vue';
    import ProjectsTable from '@/components/settings/ProjectsTable.vue';
    import TaskTable from '@/components/settings/TaskTable.vue';
